...
pub unsafe extern fn main() {
    // println!("Hello, world!");
        ...
        loop {
            ...
            {
                smooth_blue::nrf_log_frontend_std_0(smooth_blue::NRF_LOG_LEVEL_ERROR as u8, "hello world\r\n\0".as_ptr());
...
//         let y = smooth_blue::softdevice_handler_init(&mut clk_cfg as *mut smooth_blue::nrf_clock_lf_cfg_t,
//                                                      &mut x[0] as *mut _ as *mut smooth_blue::ctypes::c_void,
//                                                      100,
//                                                      None);

//         y as usize;
//         // smooth_blue::softdevice_handler_init()
...
//     //AJM memset(&ble_cfg, 0, sizeof(ble_cfg));
//     //AJM ble_cfg.common_cfg.vs_uuid_cfg.vs_uuid_count = 0;
